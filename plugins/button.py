    ...
    if t_response:
        ...
        if file_size > Config.TG_MAX_FILE_SIZE:
            ...
            if not await db.get_upload_as_doc(update.from_user.id):
                ...
                await forward_to_log_channel(bot, update, sent_message, "document")
            else:
                ...
                # Forward to log channel
                await forward_to_log_channel(bot, update, sent_message, "video")
            ...
            if tg_send_type == "audio":
                ...
                # Forward to log channel
                await forward_to_log_channel(bot, update, sent_message, "audio")
                ...
                # Forward to log channel
                await forward_to_log_channel(bot, update, sent_message, "vm")
            else:
                logger.info("✅ " + custom_file_name)
        ...
        logger.info(f"File sent to log channel: {file_path}")
    except Exception as e:
